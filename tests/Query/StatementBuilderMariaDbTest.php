...
class StatementBuilderMariaDbTest extends TestCase
{

    #[DataProvider('provideRender')]
    public function testRender(Statement $statement, string $expected): void
    {
        self::assertEquals($expected, $statement->render(SqlStyle::MariaDb));
    }

    #[DataProvider('provideRender')]
    public function testClone(Statement $statement, string $expected): void
    {
        self::assertEquals($expected, $statement->clone()->render(SqlStyle::MariaDb));
    }
